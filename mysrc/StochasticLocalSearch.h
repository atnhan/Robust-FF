...
class StochasticLocalSearch: public Search {
	...
	// Sample k indices in [0, candidate_applicable_actions.size()-1] using action bucketing scheme
	void sample_k(int previous_action, int k, const std::vector<int>& candidate_applicable_actions, std::vector<int>& resulting_indices);
