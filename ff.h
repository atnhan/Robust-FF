...
typedef enum _Connective{TRU,
	...
	typedef struct _NormOperator {
		 ...
		 * TUAN (begin)
		 */
		int *poss_precond_annotation_id;
		Fact *poss_preconds;
		int num_poss_preconds;
		int *poss_add_annotation_id;
		Fact *poss_adds;
		int num_poss_adds;
		int *poss_del_annotation_id;
		Fact *poss_dels;
		int num_poss_dels;
		/*
		 * TUAN (end)
	...
	typedef struct _EfConn {
		 ...
		 * TUAN (begin)
		 */
		int *poss_PC_annotation_id;
		int *poss_PC;
		int num_poss_PC;
		int *poss_A_annotation_id;
		int *poss_A;
		int num_poss_A;
		int *poss_D_annotation_id;
		int *poss_D;
		int num_poss_D;
		/*
		 * TUAN (end)
	...
	typedef struct _State {
		...
		int *F;		/*TUAN: note that in our work, these are set of facts possibly true.*/
		int num_F;
