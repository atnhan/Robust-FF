...
void print_plops( PlOperator *plop )
{
	...
	for ( i_plop = plop; i_plop!=NULL; i_plop = i_plop->next ) {
		 ...
		 */
		printf("\n\nposs_preconditions:\n");
		print_PlNode(i_plop->poss_preconds, 0);
		/*
		 * TUAN (end)
		 */
		 ...
		 */
		printf("poss_effects:\n");
		print_PlNode(i_plop->poss_effects, 0);
		/*
		 * TUAN (end)
		 */
...

{
	...
	if (e) {
		if (e->next) {
			printf("More than enough possible conditional effects. File %s, line %d.\n\n",__FILE__,__LINE__);
			exit(1);
		}
		printf("\nConditions\n");
		print_Wff(e->conditions, 0);	// Should be NULL
...

{
	...
	for (i=0;i<o->num_poss_preconds;i++) {
		print_Fact( &(o->poss_preconds[i]) );
		printf("\n");
		printf("Annotation ID: %d\n",o->poss_precond_annotation_id[i]);
	}
	/*
	 * TUAN (end)
	 */
	...
	for (i=0;i<o->num_poss_adds;i++) {
		print_Fact( &(o->poss_adds[i]) );
		printf("\n");
		printf("Annotation ID: %d\n",o->poss_add_annotation_id[i]);
	}
	printf("\nPossible delete effects:\n");
	for (i=0;i<o->num_poss_dels;i++) {
		print_Fact( &(o->poss_dels[i]) );
		printf("\n");
		printf("Annotation ID: %d\n",o->poss_del_annotation_id[i]);
	}
	/*
	 * TUAN (end)
	 */
...

{
	 ...
	 */
	printf("\n\nPossible Preconds:\n");
	for ( i = 0; i < a->num_poss_preconds; i++ ) {
		print_ft_name( a->poss_preconds[i] );
		printf("\n");
	}
	/*
	 * TUAN (end)
	 ...
	 */
	printf("\nPossible adds:\n");
	for ( i = 0; i < a->num_poss_adds; i++ ) {
		print_ft_name( a->poss_adds[i] );
		printf("\n");
	}
	printf("\n\nPossible dels:\n");
	for ( i = 0; i < a->num_poss_dels; i++ ) {
		print_ft_name( a->poss_dels[i] );
		printf("\n");
	}
	/*
	 * TUAN (end)
