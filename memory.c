...

{
	 ...
	 * TUAN (begin)
	 */
	result->poss_preconds = NULL;
	result->poss_effects = NULL;
	/*
	 * TUAN (end)
	 */
...

{
	...
	result->poss_preconds = NULL;
	result->num_poss_preconds = 0;
	result->poss_adds = NULL;
	result->num_poss_adds = 0;
	result->poss_dels = NULL;
	result->num_poss_dels = 0;
	/*
	 * TUAN (end)
	 */
